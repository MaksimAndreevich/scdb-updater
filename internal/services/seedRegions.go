...
func SeedRegions(districts []models.FederalDistrict) {
	...
	for i, region := range regions {
		...
		_, err := stmt.Exec(
			...
			region.NameEn,
			federalDistrictID,
			region.Namecase.Nominative,
			region.Namecase.Genitive,
			region.Namecase.Dative,
			region.Namecase.Accusative,
			region.Namecase.Ablative,
			region.Namecase.Prepositional,
			region.Namecase.Locative,
			region.Capital.Name,
			region.Capital.Label,
			region.Capital.KladrID,
			region.Capital.OKATO,
			region.Capital.OKTMO,
			region.Capital.ContentType,
		)
